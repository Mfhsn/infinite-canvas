...
export function ImageToolSettingsModal({
    ...
    const previewTools: PreviewTool[] = [
        ...selectedTools,
        { id: "more", title: t("canvas.quickTools.configure"), label: t("common.more"), icon: <Ellipsis className="size-4" />, active: true },
    ];
    ...
    return (
        <Modal
            title={t("canvas.quickTools.customize")}
            open={open}
            centered
            width={760}
            onCancel={onCancel}
            ...
            footer={
                <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2">
                        <span>{t("canvas.quickTools.showLabels")}</span>
        ...
        >
            ...
            <Card
                ...
                title={
                    <Space size={6}>
                        ...
                        {t("canvas.quickTools.nodePreview")}
                    </Space>
                }
                className="mb-4"
            >
                <div className="relative flex min-h-[300px] w-full justify-center pt-20 pb-9">
                    ...
                    >
                        ...
                        <Typography.Text type="secondary">{t("canvas.quickTools.imageNode")}</Typography.Text>
                    </div>
                    <input
            ...
            <Form layout="vertical" className="!mb-0">
                <Form.Item
                    ...
                    label={
                        <Space size={8}>
                            <span>{t("canvas.quickTools.title")}</span>
                            <Tag className="m-0">
